...
* All motors are powered up.
* The serial USB port for the U2D2 is connected ro the controlling computer.
* That you have started the driver and that topics listed below are available.

```text
# Start package in terminal 1.
# Launch the driver.
ros2 launch dynamixel_driver driver.launch.py
# Verify that the correct topics are published.
$ ros2 topic list
/all_motors
/battery_state
/diagnostics
...
The topic `all_motors` uses the `pipebot-msgs/msg/MultipleWheelDrive` message.  Velocity and relative position are implemented.

```text
# Rotate all motors by 3.1 radians (about 180 degrees) using relative position mode aka MODE_RELATIVE.
ros2 topic pub -1 /all_motors pipebot_msgs/msg/MultipleWheelDrive "{motors: [ {id: 2, mode: 1, angle_radians: 3.1}, {id: 3, mode: 1, angle_radians: 3.1}, {id: 4, mode: 1, angle_radians: 3.1}, {id: 5, mode: 1, angle_radians: 3.1}] }"
# Reject command with different modes.
ros2 topic pub -1 /all_motors pipebot_msgs/msg/MultipleWheelDrive "{motors: [ {id: 2, mode: 1, angle_radians: 3.1}, {id: 3, mode: 1, angle_radians: 3.1}, {id: 4, mode: 1, angle_radians: 3.1}, {id: 5, mode: 2, angle_radians: 3.1}] }"
